                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                    {exp.photos.map((photo, pIdx) => (
                      <div
                        ...
                        className="relative aspect-video rounded-xl overflow-hidden cursor-pointer group border border-[var(--border-subtle)] bg-slate-900/40"
                      >
                        <Image
                          src={photo}
                        ...
                        <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                          <span className="px-3 py-1 rounded-full text-[10px] font-bold bg-black/70 text-white backdrop-blur-sm">
                            Perbesar Foto
                          </span>
                        </div>
                      </div>
